function [Kuu, Kup, Kpp, S] = NotUse_ComputeSystemMatrices_Steady(Material, MeshU, MeshP, Quad)
...
% ------------------------------------------------------------------------
% (DO NOT USE) version 3: old assembly for coupled matrix 
% ------------------------------------------------------------------------
