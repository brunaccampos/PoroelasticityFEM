...
%% Model name and type
disp([num2str(toc),': Model: BT u-p-v dynamic']);

%% Assemble system matrices
disp([num2str(toc),': Assembling System Matrices...']);
[Mss, Msf, Kss, Ksp, Kps, Kpf, Mff, Kff, Cfs, Kfp, Kpp] = ComputeMatricesDyn_BT_UPV(Material, MeshU, MeshP, QuadU, QuadP);
...
for t = 1:length(Plot.time)
    ...
    % linear solver
    [Solution] = SolverDyn_UPV(Mss, Msf, Kss, Ksp, Kps, Kpf, Mff, Kff, Cfs, Kfp, Kpp, fu, fp, ff, BC, Control, Iteration);
