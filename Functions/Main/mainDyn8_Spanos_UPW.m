...
%% Model name and type
disp([num2str(toc),': Model: Spanos u-p-w dynamic case']);

%% Assemble system matrices
disp([num2str(toc),': Assembling System Matrices...']);
[Mss, Msf, Kss, Ksp, Mfs, Mff, Kfp, Kff, Cps, Kpf, Cpp] = ComputeMatricesDyn8_Spanos_UPW(Material, MeshU, MeshP, QuadU, QuadP);
...
for t = 1:length(Plot.time)
    ...
    % linear solver
    [Solution] = SolverDyn_UPW(Mss, Msf, Kss, Ksp, Mfs, Mff, Kfp, Kff, Cps, Kpf, Cpp, fu, fp, ff, BC, Control, Iteration);
