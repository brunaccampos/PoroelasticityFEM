...
[Mss, Msf, Kss, Ksp, Mfs, Mff, Kfp, Kff, Cps, Kpf] = ComputeMatricesDyn7_Biot_UPW(Material, MeshU, MeshP, QuadU, QuadP);
...
for t = 1:length(Plot.time)
    ...
    % linear solver
    [Solution] = SolverDyn_UPW(Mss, Msf, Kss, Ksp, Mfs, Mff, Kfp, Kff, Cps, Kpf, fu, fp, ff, BC, Control, Iteration);
