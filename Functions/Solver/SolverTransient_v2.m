function [Solution] = SolverTransient_v2(Kuu, Kup, Kpp, Kpu, S, Kpn, Knn, Knu, Knp, Aun, Bun, fu, fp, fn, BC, Control, Iteration)
% ------------------------------------------------------------------------
...
%   p: fluid pressure
% ------------------------------------------------------------------------
% version 2: adding matrices for Spanos model
% ------------------------------------------------------------------------
