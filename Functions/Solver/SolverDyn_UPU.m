function [Solution] = SolverDyn_UPU(Kss, Ksp, Mss, Csf, Css, Kpf, Kps, Kpp, Kfp, Mff, Cff, Cfs, Msf, Mfs, fu, fp, ff, BC, Control, Iteration)
% ------------------------------------------------------------------------
...
Kfpbar = -Kfp;
Kffbar = Mff./(lambda*dt^2) + Cff*(xi/lambda/dt);
