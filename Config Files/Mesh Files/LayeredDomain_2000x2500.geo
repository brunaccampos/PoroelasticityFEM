...
//+
Point(3) = {4000, 900, 0, 1.0};
//+
Point(4) = {4000, 1100, 0, 1.0};
//+
Point(5) = {4000, 2000, 0, 1.0};
//+
Point(6) = {0, 2000, 0, 1.0};
//+
Point(7) = {0, 1100, 0, 1.0};
//+
Point(8) = {0, 900, 0, 1.0};
//+
Point(9) = {1000, 0, 0, 1.0};
//+
Point(10) = {1000, 900, 0, 1.0};
//+ 
Point(11) = {1000, 1100, 0, 1.0};
//+
Point(12) = {1000, 2000, 0, 1.0};
//+ 
Point(13) = {3000, 0, 0, 1.0};
//+
Point(14) = {3000, 900, 0, 1.0};
//+
Point(15) = {3000, 1100, 0, 1.0};
//+
