function [Material, MeshU, MeshP, MeshN, BC, Control] = WaveProp_MatLayer2000x4000(config_dir, progress_on,~,~)
...
%%%% displacement field
fieldU = 'u';
meshFileNameU = 'Mesh Files\LayeredDomain_2000x4000Q9.msh';
MeshU = BuildMesh_GMSH(meshFileNameU, fieldU, nsd, config_dir, progress_on);
% type of material per element
MeshU.MatList = zeros(MeshU.ne, 1, 'int8');
% find nodes correspondent to each material
nodes_mat1 = find(MeshU.coords(:,2) > 800 & MeshU.coords(:,2) < 1200);
