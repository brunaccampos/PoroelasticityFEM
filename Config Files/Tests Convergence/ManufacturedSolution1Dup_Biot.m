...
% body force [GN/m3]
BC.b = @(x,t) (Material.E*F1^2*sin(F1*x+F2*t) + Material.alpha*F1*cos(F1*x) - ...
    Material.rho*F2^2*sin(F1*x+F2*t))./1000;
...
% flux source [m3/s/m3]
% BC.s = @(x,t) (F1*cos(F1*x) - Material.rhof*F2^2*sin(F1*x+F2*t) - ...
%     Material.alpha*Material.muf*F2/Material.k*cos(F1*x+F2*t) - ...
%     Material.muf*F2*x*Material.Minv/Material.k*cos(F2*t))./1000;
% BC.s = @(x,t) (-F1^2*sin(F1*x) - Material.rhof*F2^2*F1*cos(F1*x+F2*t) + ...
%     Material.alpha*Material.muf/Material.k*F1*F2*sin(F1*x+F2*t) - ...
%     Material.muf*Material.Minv/Material.k*F2*cos(F2*t))./1000;

BC.s = @(x,t) (Material.k/Material.muf*F1^2*sin(F1*x) + Material.k/Material.muf*Material.rhof*F2^2*F1*cos(F1*x+F2*t) - ...
    Material.alpha*F1*F2*sin(F1*x+F2*t) + Material.Minv*F2*cos(F2*t))./1000;
