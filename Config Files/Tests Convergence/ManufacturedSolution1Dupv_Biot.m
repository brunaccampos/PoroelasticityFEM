...
BC.bs = @(x,t) (Material.M(1).E * t^2 * sin(x*t) + Material.M(1).alpha*t*(cos(x*t)^2-sin(x*t)^2) -...
    (1-Material.M(1).eta0)*Material.M(1).rhos*x^2*sin(x*t) - Material.M(1).eta0*Material.M(1).rhof*x*sin(x*t))./1000;

BC.bf = @(x,t) (Material.M(1).eta0*(cos(x*t)^2-sin(x*t)^2) - Material.M(1).eta0*Material.M(1).rhof*x*sin(x*t) + ...
    Material.M(1).muf*Material.M(1).eta0^2/Material.M(1).k*(1-x)*cos(x*t))./1000;
...
% flux source [m3/s/m3]
BC.s = @(x,t) (Material.M(1).Minv*x*(cos(x*t)^2-sin(x*t)^2) + (Material.M(1).alpha-Material.M(1).eta0)*(cos(x*t)-x*t*sin(x*t)) - ...
    Material.M(1).eta0*t*sin(x*t))./1000;
