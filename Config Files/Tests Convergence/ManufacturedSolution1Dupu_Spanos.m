...
BC.bs = @(x,t) (Material.E*F1^2*sin(F1*x+F2*t) + (Material.alpha-Material.eta0)*F1*cos(F1*x)- ...
    (1-Material.eta0)*Material.rhos*F2^2*sin(F1*x+F2*t) + ...
    (Material.muf*Material.eta0^2/Material.k)*F2*(sin(F1*x+F2*t)+cos(F1*x+F2*t)) + ...
    (4*Material.eta0*Material.muf/3+Material.eta0*Material.xif-Material.xif*Material.deltaf)*F1^2*F2*sin(F1*x+F2*t) - ...
    Material.xif*Material.deltas*F1^2*F2*cos(F1*x+F2*t))./1000;

BC.bf = @(x,t) (Material.eta0*F1*cos(F1*x) - Material.eta0*Material.rhof*F2^2*cos(F1*x+F2*t) -...
    (Material.muf*Material.eta0^2/Material.k)*F2*(sin(F1*x+F2*t)+cos(F1*x+F2*t)) - ...
    (4*Material.eta0*Material.muf/3+Material.eta0*Material.xif-Material.xif*Material.deltaf)*F1^2*F2*sin(F1*x+F2*t) + ...
    Material.xif*Material.deltas*F1^2*F2*cos(F1*x+F2*t))./1000;
...
% flux source [m3/s/m3]
BC.s = @(x,t) (Material.deltas*F1/Material.eta0*cos(F1*x+F2*t) - (1-Material.deltaf/Material.eta0)*F1*sin(F1*x+F2*t) +...
