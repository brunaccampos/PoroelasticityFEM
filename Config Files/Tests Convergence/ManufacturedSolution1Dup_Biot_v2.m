...
% body force [GN/m3]
BC.b = @(x,t) (Material.E*F1^2*sin(F1*x+F2*t) + Material.alpha*F1*cos(F1*x))./1000;
...
% flux source [m3/s/m3]
BC.s = @(x,t) (Material.k/Material.muf*F1^2*sin(F1*x) - Material.alpha*F1*F2*sin(F1*x+F2*t) + ...
    Material.Minv*F2*cos(F2*t))./1000;
