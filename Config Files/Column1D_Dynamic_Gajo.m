function [Material, MeshU, MeshP, MeshN, BC, Control] = Column1D_Dynamic_Gajo(config_dir, progress_on)
...
%                                   porosity perturbation equation
Control.Biotmodel = 'Dynamic_BiotUUP';
