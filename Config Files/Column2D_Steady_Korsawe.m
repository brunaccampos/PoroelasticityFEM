function [Material, MeshU, MeshP, MeshN, BC, Control] = Column2D_Steady_Korsawe(config_dir, progress_on)
...
switch MeshType
    ...
    case 'Gmsh'
        ...
        %%%% displacement field
        fieldU = 'u';
        meshFileNameU = 'Mesh Files\Column2DQ9_Steady_Korsawe10el.msh';
        MeshU = BuildMesh_GMSH(meshFileNameU, fieldU, nsd, config_dir, progress_on);
        %%%% pressure field
        fieldP = 'p';
        meshFileNameP = 'Mesh Files\Column2DQ4_Steady_Korsawe10el.msh';
        MeshP = BuildMesh_GMSH(meshFileNameP, fieldP, nsd, config_dir, progress_on);
        %%%% porosity field
        if ~Control.Biotmodel
            fieldN = 'n';
            meshFileNameN = 'Mesh Files\Column2DQ4_Steady_Korsawe10el.msh';
...
% for mesh with 10 elements in height
Control.plotu = 70*2; % dof y of node 70 (x = 0.05m, y = 0.5m)
Control.plotp = 42; % dof y of node 42 (x = 0.05m, y = 0.5m)
