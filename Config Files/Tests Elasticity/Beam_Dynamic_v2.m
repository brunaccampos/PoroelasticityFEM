...
switch MeshType
    ...
    % Manual 2D mesh
        ...
        MeshU.nn = 6; % number of nodes
        MeshU.ne = 2; % number of elements
        ...
        % x coordinates
        MeshU.coords(:,1) = [(0:2)'; (0:2)'];
        % y coordinates
        MeshU.coords(:,2) = [zeros(3,1); ones(3,1)];
        ...
        MeshP.nn = 6; % number of nodes
        MeshP.ne = 2; % number of elements
        ...
        % x coordinates
        MeshP.coords(:,1) = [(0:2)'; (0:2)'];
        % y coordinates
        MeshP.coords(:,2) = [zeros(3,1); ones(3,1)];
        % elements connectivity
        MeshP.conn = [1, 2, 5, 4;
                    2, 3, 6, 5]; 
...
Control.tend = 50;   % final simulation time
