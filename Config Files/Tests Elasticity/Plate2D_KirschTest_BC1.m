function [Material, MeshU, MeshP, MeshN, BC, Control] = Plate2D_KirschTest_BC1(config_dir, progress_on)
...
%% Plot data
% DOF to plot graphs
Control.plotu = 9*2; % dof y of node 354 (x = 60m, y = 25m)
Control.plotp = 9; % dof of node 209 (x = 60m, y = 25m)
